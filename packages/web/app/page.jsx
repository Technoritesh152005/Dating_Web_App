...
export default function LandingPage() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
      {/* Ambient background - soft, slow-drifting blooms evoking string
          lights at dusk. Abstracted, never literal (no flower/light icons) -
          this is the theme expressed as pure color and motion. */}
